...
| BMI2  | Yes but slow ([#42](https://github.com/AuburnSounds/intel-intrinsics/issues/42)) | Yes (use -mattr=+bmi2)   | Yes    | Yes but disabled ([#39](https://github.com/AuburnSounds/intel-intrinsics/issues/39))  |
