...
*/
extern (C) int _aApplyRcd1(scope const(char)[] aa, dg_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRwd1(scope const(wchar)[] aa, dg_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRcw1(scope const(char)[] aa, dg_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRwc1(scope const(wchar)[] aa, dg_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRdc1(scope const(dchar)[] aa, dg_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRdw1(scope const(dchar)[] aa, dg_t dg) @system
{   int result;
...
*/
extern (C) int _aApplyRcd2(scope const(char)[] aa, dg2_t dg) @system
{   int result;
    size_t i;
...
/// ditto
extern (C) int _aApplyRwd2(scope const(wchar)[] aa, dg2_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRcw2(scope const(char)[] aa, dg2_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRwc2(scope const(wchar)[] aa, dg2_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRdc2(scope const(dchar)[] aa, dg2_t dg) @system
{   int result;
...
/// ditto
extern (C) int _aApplyRdw2(scope const(dchar)[] aa, dg2_t dg) @system
{   int result;
