...
extern( System ) {
    ...
    // VK_NVX_raytracing
    alias PFN_vkCreateAccelerationStructureNVX                       = VkResult  function( VkDevice device, const( VkAccelerationStructureCreateInfoNVX )* pCreateInfo, const( VkAllocationCallbacks )* pAllocator, VkAccelerationStructureNVX* pAccelerationStructure );
    alias PFN_vkDestroyAccelerationStructureNVX                      = void      function( VkDevice device, VkAccelerationStructureNVX accelerationStructure, const( VkAllocationCallbacks )* pAllocator );
    alias PFN_vkGetAccelerationStructureMemoryRequirementsNVX        = void      function( VkDevice device, const( VkAccelerationStructureMemoryRequirementsInfoNVX )* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements );
    alias PFN_vkGetAccelerationStructureScratchMemoryRequirementsNVX = void      function( VkDevice device, const( VkAccelerationStructureMemoryRequirementsInfoNVX )* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements );
    alias PFN_vkBindAccelerationStructureMemoryNVX                   = VkResult  function( VkDevice device, uint32_t bindInfoCount, const( VkBindAccelerationStructureMemoryInfoNVX )* pBindInfos );
    alias PFN_vkCmdBuildAccelerationStructureNVX                     = void      function( VkCommandBuffer commandBuffer, VkAccelerationStructureTypeNVX type, uint32_t instanceCount, VkBuffer instanceData, VkDeviceSize instanceOffset, uint32_t geometryCount, const( VkGeometryNVX )* pGeometries, VkBuildAccelerationStructureFlagsNVX flags, VkBool32 update, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkBuffer scratch, VkDeviceSize scratchOffset );
    alias PFN_vkCmdCopyAccelerationStructureNVX                      = void      function( VkCommandBuffer commandBuffer, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkCopyAccelerationStructureModeNVX mode );
    alias PFN_vkCmdTraceRaysNVX                                      = void      function( VkCommandBuffer commandBuffer, VkBuffer raygenShaderBindingTableBuffer, VkDeviceSize raygenShaderBindingOffset, VkBuffer missShaderBindingTableBuffer, VkDeviceSize missShaderBindingOffset, VkDeviceSize missShaderBindingStride, VkBuffer hitShaderBindingTableBuffer, VkDeviceSize hitShaderBindingOffset, VkDeviceSize hitShaderBindingStride, uint32_t width, uint32_t height );
    alias PFN_vkCreateRaytracingPipelinesNVX                         = VkResult  function( VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const( VkRaytracingPipelineCreateInfoNVX )* pCreateInfos, const( VkAllocationCallbacks )* pAllocator, VkPipeline* pPipelines );
    alias PFN_vkGetRaytracingShaderHandlesNVX                        = VkResult  function( VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData );
    alias PFN_vkGetAccelerationStructureHandleNVX                    = VkResult  function( VkDevice device, VkAccelerationStructureNVX accelerationStructure, size_t dataSize, void* pData );
    alias PFN_vkCmdWriteAccelerationStructurePropertiesNVX           = void      function( VkCommandBuffer commandBuffer, VkAccelerationStructureNVX accelerationStructure, VkQueryType queryType, VkQueryPool queryPool, uint32_t query );
    alias PFN_vkCompileDeferredNVX                                   = VkResult  function( VkDevice device, VkPipeline pipeline, uint32_t shader );
...
void loadDeviceLevelFunctions( VkInstance instance ) {
    ...
    // VK_NVX_raytracing
    vkCreateAccelerationStructureNVX                       = cast( PFN_vkCreateAccelerationStructureNVX                       ) vkGetInstanceProcAddr( instance, "vkCreateAccelerationStructureNVX" );
    vkDestroyAccelerationStructureNVX                      = cast( PFN_vkDestroyAccelerationStructureNVX                      ) vkGetInstanceProcAddr( instance, "vkDestroyAccelerationStructureNVX" );
    vkGetAccelerationStructureMemoryRequirementsNVX        = cast( PFN_vkGetAccelerationStructureMemoryRequirementsNVX        ) vkGetInstanceProcAddr( instance, "vkGetAccelerationStructureMemoryRequirementsNVX" );
    vkGetAccelerationStructureScratchMemoryRequirementsNVX = cast( PFN_vkGetAccelerationStructureScratchMemoryRequirementsNVX ) vkGetInstanceProcAddr( instance, "vkGetAccelerationStructureScratchMemoryRequirementsNVX" );
    vkBindAccelerationStructureMemoryNVX                   = cast( PFN_vkBindAccelerationStructureMemoryNVX                   ) vkGetInstanceProcAddr( instance, "vkBindAccelerationStructureMemoryNVX" );
    vkCmdBuildAccelerationStructureNVX                     = cast( PFN_vkCmdBuildAccelerationStructureNVX                     ) vkGetInstanceProcAddr( instance, "vkCmdBuildAccelerationStructureNVX" );
    vkCmdCopyAccelerationStructureNVX                      = cast( PFN_vkCmdCopyAccelerationStructureNVX                      ) vkGetInstanceProcAddr( instance, "vkCmdCopyAccelerationStructureNVX" );
    vkCmdTraceRaysNVX                                      = cast( PFN_vkCmdTraceRaysNVX                                      ) vkGetInstanceProcAddr( instance, "vkCmdTraceRaysNVX" );
    vkCreateRaytracingPipelinesNVX                         = cast( PFN_vkCreateRaytracingPipelinesNVX                         ) vkGetInstanceProcAddr( instance, "vkCreateRaytracingPipelinesNVX" );
    vkGetRaytracingShaderHandlesNVX                        = cast( PFN_vkGetRaytracingShaderHandlesNVX                        ) vkGetInstanceProcAddr( instance, "vkGetRaytracingShaderHandlesNVX" );
    vkGetAccelerationStructureHandleNVX                    = cast( PFN_vkGetAccelerationStructureHandleNVX                    ) vkGetInstanceProcAddr( instance, "vkGetAccelerationStructureHandleNVX" );
    vkCmdWriteAccelerationStructurePropertiesNVX           = cast( PFN_vkCmdWriteAccelerationStructurePropertiesNVX           ) vkGetInstanceProcAddr( instance, "vkCmdWriteAccelerationStructurePropertiesNVX" );
    vkCompileDeferredNVX                                   = cast( PFN_vkCompileDeferredNVX                                   ) vkGetInstanceProcAddr( instance, "vkCompileDeferredNVX" );
...
void loadDeviceLevelFunctions( VkDevice device ) {
    ...
    // VK_NVX_raytracing
    vkCreateAccelerationStructureNVX                       = cast( PFN_vkCreateAccelerationStructureNVX                       ) vkGetDeviceProcAddr( device, "vkCreateAccelerationStructureNVX" );
    vkDestroyAccelerationStructureNVX                      = cast( PFN_vkDestroyAccelerationStructureNVX                      ) vkGetDeviceProcAddr( device, "vkDestroyAccelerationStructureNVX" );
    vkGetAccelerationStructureMemoryRequirementsNVX        = cast( PFN_vkGetAccelerationStructureMemoryRequirementsNVX        ) vkGetDeviceProcAddr( device, "vkGetAccelerationStructureMemoryRequirementsNVX" );
    vkGetAccelerationStructureScratchMemoryRequirementsNVX = cast( PFN_vkGetAccelerationStructureScratchMemoryRequirementsNVX ) vkGetDeviceProcAddr( device, "vkGetAccelerationStructureScratchMemoryRequirementsNVX" );
    vkBindAccelerationStructureMemoryNVX                   = cast( PFN_vkBindAccelerationStructureMemoryNVX                   ) vkGetDeviceProcAddr( device, "vkBindAccelerationStructureMemoryNVX" );
    vkCmdBuildAccelerationStructureNVX                     = cast( PFN_vkCmdBuildAccelerationStructureNVX                     ) vkGetDeviceProcAddr( device, "vkCmdBuildAccelerationStructureNVX" );
    vkCmdCopyAccelerationStructureNVX                      = cast( PFN_vkCmdCopyAccelerationStructureNVX                      ) vkGetDeviceProcAddr( device, "vkCmdCopyAccelerationStructureNVX" );
    vkCmdTraceRaysNVX                                      = cast( PFN_vkCmdTraceRaysNVX                                      ) vkGetDeviceProcAddr( device, "vkCmdTraceRaysNVX" );
    vkCreateRaytracingPipelinesNVX                         = cast( PFN_vkCreateRaytracingPipelinesNVX                         ) vkGetDeviceProcAddr( device, "vkCreateRaytracingPipelinesNVX" );
    vkGetRaytracingShaderHandlesNVX                        = cast( PFN_vkGetRaytracingShaderHandlesNVX                        ) vkGetDeviceProcAddr( device, "vkGetRaytracingShaderHandlesNVX" );
    vkGetAccelerationStructureHandleNVX                    = cast( PFN_vkGetAccelerationStructureHandleNVX                    ) vkGetDeviceProcAddr( device, "vkGetAccelerationStructureHandleNVX" );
    vkCmdWriteAccelerationStructurePropertiesNVX           = cast( PFN_vkCmdWriteAccelerationStructurePropertiesNVX           ) vkGetDeviceProcAddr( device, "vkCmdWriteAccelerationStructurePropertiesNVX" );
    vkCompileDeferredNVX                                   = cast( PFN_vkCompileDeferredNVX                                   ) vkGetDeviceProcAddr( device, "vkCompileDeferredNVX" );
