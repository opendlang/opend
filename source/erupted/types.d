...
struct VkPhysicalDeviceShaderFloat16Int8FeaturesKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES_KHR;
    void*            pNext;
...
struct VkPerformanceCounterKHR {
    ...
    VkPerformanceCounterScopeKHR    _scope;
...
struct VkPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR;
    void*            pNext;
...
enum VkDriverIdKHR {
    ...
    VK_DRIVER_IDKHR_END_RANGE_KHR                = VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR,
    VK_DRIVER_IDKHR_RANGE_SIZE_KHR               = VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR - VK_DRIVER_ID_AMD_PROPRIETARY_KHR + 1,
...
enum VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR       = VkDriverIdKHR.VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR;
...
struct VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES_KHR;
    void*            pNext;
    VkBool32         separateDepthStencilLayouts;
}

struct VkAttachmentReferenceStencilLayoutKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT_KHR;
    void*            pNext;
    VkImageLayout    stencilLayout;
}

struct VkAttachmentDescriptionStencilLayoutKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT_KHR;
    void*            pNext;
...
struct VkPhysicalDeviceBufferDeviceAddressFeaturesKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_KHR;
    void*            pNext;
...
struct VkBufferDeviceAddressInfoKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_KHR;
    const( void )*   pNext;
    VkBuffer         buffer;
}

struct VkBufferOpaqueCaptureAddressCreateInfoKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO_KHR;
    const( void )*   pNext;
    uint64_t         opaqueCaptureAddress;
}

struct VkMemoryOpaqueCaptureAddressAllocateInfoKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO_KHR;
    const( void )*   pNext;
    uint64_t         opaqueCaptureAddress;
}

struct VkDeviceMemoryOpaqueCaptureAddressInfoKHR {
    VkStructureType  sType = VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO_KHR;
    const( void )*   pNext;
    VkDeviceMemory   memory;
}
...
enum VK_EXT_FILTER_CUBIC_SPEC_VERSION = 2;
...
struct VkPhysicalDeviceToolPropertiesEXT {
    ...
    char[ VK_MAX_EXTENSION_NAME_SIZE ]  _version;
...
enum VK_EXT_VALIDATION_FEATURES_SPEC_VERSION = 2;
