...
enum VK_STRUCTURE_TYPE_IMAGE_EXCPLICIT_DRM_FORMAT_MODIFIER_CREATE_INFO_EXT               = VkStructureType.VK_STRUCTURE_TYPE_IMAGE_EXCPLICIT_DRM_FORMAT_MODIFIER_CREATE_INFO_EXT;
...
enum VK_STRUCTURE_TYPE_RAYTRACING_PIPELINE_CREATE_INFO_NVX                               = VkStructureType.VK_STRUCTURE_TYPE_RAYTRACING_PIPELINE_CREATE_INFO_NVX;
enum VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NVX                            = VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NVX;
enum VK_STRUCTURE_TYPE_GEOMETRY_INSTANCE_NVX                                             = VkStructureType.VK_STRUCTURE_TYPE_GEOMETRY_INSTANCE_NVX;
enum VK_STRUCTURE_TYPE_GEOMETRY_NVX                                                      = VkStructureType.VK_STRUCTURE_TYPE_GEOMETRY_NVX;
enum VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NVX                                            = VkStructureType.VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NVX;
enum VK_STRUCTURE_TYPE_GEOMETRY_AABB_NVX                                                 = VkStructureType.VK_STRUCTURE_TYPE_GEOMETRY_AABB_NVX;
enum VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NVX                       = VkStructureType.VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NVX;
enum VK_STRUCTURE_TYPE_DESCRIPTOR_ACCELERATION_STRUCTURE_INFO_NVX                        = VkStructureType.VK_STRUCTURE_TYPE_DESCRIPTOR_ACCELERATION_STRUCTURE_INFO_NVX;
enum VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NVX               = VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NVX;
enum VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAYTRACING_PROPERTIES_NVX                         = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAYTRACING_PROPERTIES_NVX;
enum VK_STRUCTURE_TYPE_HIT_SHADER_MODULE_CREATE_INFO_NVX                                 = VkStructureType.VK_STRUCTURE_TYPE_HIT_SHADER_MODULE_CREATE_INFO_NVX;
...
enum VK_QUERY_TYPE_COMPACTED_SIZE_NVX            = VkQueryType.VK_QUERY_TYPE_COMPACTED_SIZE_NVX;
...
enum VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NVX       = VkDescriptorType.VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NVX;
...
enum VK_PIPELINE_BIND_POINT_RAYTRACING_NVX       = VkPipelineBindPoint.VK_PIPELINE_BIND_POINT_RAYTRACING_NVX;
...
enum VK_OBJECT_TYPE_ACCELERATION_STRUCTURE_NVX           = VkObjectType.VK_OBJECT_TYPE_ACCELERATION_STRUCTURE_NVX;
...
enum VK_PIPELINE_STAGE_RAYTRACING_BIT_NVX                        = VkPipelineStageFlagBits.VK_PIPELINE_STAGE_RAYTRACING_BIT_NVX;
...
enum VK_BUFFER_USAGE_RAYTRACING_BIT_NVX                          = VkBufferUsageFlagBits.VK_BUFFER_USAGE_RAYTRACING_BIT_NVX;
...
enum VK_PIPELINE_CREATE_DEFER_COMPILE_BIT_NVX                    = VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_DEFER_COMPILE_BIT_NVX;
...
enum VK_SHADER_STAGE_RAYGEN_BIT_NVX              = VkShaderStageFlagBits.VK_SHADER_STAGE_RAYGEN_BIT_NVX;
enum VK_SHADER_STAGE_ANY_HIT_BIT_NVX             = VkShaderStageFlagBits.VK_SHADER_STAGE_ANY_HIT_BIT_NVX;
enum VK_SHADER_STAGE_CLOSEST_HIT_BIT_NVX         = VkShaderStageFlagBits.VK_SHADER_STAGE_CLOSEST_HIT_BIT_NVX;
enum VK_SHADER_STAGE_MISS_BIT_NVX                = VkShaderStageFlagBits.VK_SHADER_STAGE_MISS_BIT_NVX;
enum VK_SHADER_STAGE_INTERSECTION_BIT_NVX        = VkShaderStageFlagBits.VK_SHADER_STAGE_INTERSECTION_BIT_NVX;
enum VK_SHADER_STAGE_CALLABLE_BIT_NVX            = VkShaderStageFlagBits.VK_SHADER_STAGE_CALLABLE_BIT_NVX;
...
enum VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NVX       = VkAccessFlagBits.VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NVX;
enum VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NVX      = VkAccessFlagBits.VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NVX;
...
enum VkDriverIdKHR {
    ...
    VK_DRIVER_IDKHR_END_RANGE_KHR                = VK_DRIVER_ID_ARM_PROPRIETARY_KHR,
    VK_DRIVER_IDKHR_RANGE_SIZE_KHR               = VK_DRIVER_ID_ARM_PROPRIETARY_KHR - VK_DRIVER_ID_AMD_PROPRIETARY_KHR + 1,
...
enum VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_NVX_EXT          = VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_NVX_EXT;
...
// - VK_NVX_raytracing -
enum VK_NVX_raytracing = 1;

mixin( VK_DEFINE_NON_DISPATCHABLE_HANDLE!q{VkAccelerationStructureNVX} );

enum VK_NVX_RAYTRACING_SPEC_VERSION = 1;
enum VK_NVX_RAYTRACING_EXTENSION_NAME = "VK_NVX_raytracing";
...
enum VK_GEOMETRY_TYPE_TRIANGLES_NVX      = VkGeometryTypeNVX.VK_GEOMETRY_TYPE_TRIANGLES_NVX;
enum VK_GEOMETRY_TYPE_AABBS_NVX          = VkGeometryTypeNVX.VK_GEOMETRY_TYPE_AABBS_NVX;
enum VK_GEOMETRY_TYPE_BEGIN_RANGE_NVX    = VkGeometryTypeNVX.VK_GEOMETRY_TYPE_BEGIN_RANGE_NVX;
enum VK_GEOMETRY_TYPE_END_RANGE_NVX      = VkGeometryTypeNVX.VK_GEOMETRY_TYPE_END_RANGE_NVX;
enum VK_GEOMETRY_TYPE_RANGE_SIZE_NVX     = VkGeometryTypeNVX.VK_GEOMETRY_TYPE_RANGE_SIZE_NVX;
enum VK_GEOMETRY_TYPE_MAX_ENUM_NVX       = VkGeometryTypeNVX.VK_GEOMETRY_TYPE_MAX_ENUM_NVX;
...
enum VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NVX        = VkAccelerationStructureTypeNVX.VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NVX;
enum VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NVX     = VkAccelerationStructureTypeNVX.VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NVX;
enum VK_ACCELERATION_STRUCTURE_TYPE_BEGIN_RANGE_NVX      = VkAccelerationStructureTypeNVX.VK_ACCELERATION_STRUCTURE_TYPE_BEGIN_RANGE_NVX;
enum VK_ACCELERATION_STRUCTURE_TYPE_END_RANGE_NVX        = VkAccelerationStructureTypeNVX.VK_ACCELERATION_STRUCTURE_TYPE_END_RANGE_NVX;
enum VK_ACCELERATION_STRUCTURE_TYPE_RANGE_SIZE_NVX       = VkAccelerationStructureTypeNVX.VK_ACCELERATION_STRUCTURE_TYPE_RANGE_SIZE_NVX;
enum VK_ACCELERATION_STRUCTURE_TYPE_MAX_ENUM_NVX         = VkAccelerationStructureTypeNVX.VK_ACCELERATION_STRUCTURE_TYPE_MAX_ENUM_NVX;
...
enum VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NVX       = VkCopyAccelerationStructureModeNVX.VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NVX;
enum VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NVX     = VkCopyAccelerationStructureModeNVX.VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NVX;
enum VK_COPY_ACCELERATION_STRUCTURE_MODE_BEGIN_RANGE_NVX = VkCopyAccelerationStructureModeNVX.VK_COPY_ACCELERATION_STRUCTURE_MODE_BEGIN_RANGE_NVX;
enum VK_COPY_ACCELERATION_STRUCTURE_MODE_END_RANGE_NVX   = VkCopyAccelerationStructureModeNVX.VK_COPY_ACCELERATION_STRUCTURE_MODE_END_RANGE_NVX;
enum VK_COPY_ACCELERATION_STRUCTURE_MODE_RANGE_SIZE_NVX  = VkCopyAccelerationStructureModeNVX.VK_COPY_ACCELERATION_STRUCTURE_MODE_RANGE_SIZE_NVX;
enum VK_COPY_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_NVX    = VkCopyAccelerationStructureModeNVX.VK_COPY_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_NVX;

enum VkGeometryFlagBitsNVX {
...
enum VK_GEOMETRY_OPAQUE_BIT_NVX                          = VkGeometryFlagBitsNVX.VK_GEOMETRY_OPAQUE_BIT_NVX;
enum VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NVX = VkGeometryFlagBitsNVX.VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NVX;
enum VK_GEOMETRY_FLAG_BITS_MAX_ENUM_NVX                  = VkGeometryFlagBitsNVX.VK_GEOMETRY_FLAG_BITS_MAX_ENUM_NVX;
alias VkGeometryFlagsNVX = VkFlags;

enum VkGeometryInstanceFlagBitsNVX {
...
enum VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_DISABLE_BIT_NVX          = VkGeometryInstanceFlagBitsNVX.VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_DISABLE_BIT_NVX;
enum VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_FLIP_WINDING_BIT_NVX     = VkGeometryInstanceFlagBitsNVX.VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_FLIP_WINDING_BIT_NVX;
enum VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NVX                   = VkGeometryInstanceFlagBitsNVX.VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NVX;
enum VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NVX                = VkGeometryInstanceFlagBitsNVX.VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NVX;
enum VK_GEOMETRY_INSTANCE_FLAG_BITS_MAX_ENUM_NVX                 = VkGeometryInstanceFlagBitsNVX.VK_GEOMETRY_INSTANCE_FLAG_BITS_MAX_ENUM_NVX;
alias VkGeometryInstanceFlagsNVX = VkFlags;

enum VkBuildAccelerationStructureFlagBitsNVX {
...
enum VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_NVX        = VkBuildAccelerationStructureFlagBitsNVX.VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_NVX;
enum VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_NVX    = VkBuildAccelerationStructureFlagBitsNVX.VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_NVX;
enum VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_NVX   = VkBuildAccelerationStructureFlagBitsNVX.VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_NVX;
enum VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_NVX   = VkBuildAccelerationStructureFlagBitsNVX.VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_NVX;
...
enum VK_BUILD_ACCELERATION_STRUCTURE_FLAG_BITS_MAX_ENUM_NVX      = VkBuildAccelerationStructureFlagBitsNVX.VK_BUILD_ACCELERATION_STRUCTURE_FLAG_BITS_MAX_ENUM_NVX;
alias VkBuildAccelerationStructureFlagsNVX = VkFlags;
