...
enum VK_ERROR_INVALID_EXTERNAL_HANDLE_KHX = VkResult.VK_ERROR_INVALID_EXTERNAL_HANDLE_KHX;
...
enum VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_INFO_KHX;
enum VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_INFO_KHX;
...
enum VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX;
enum VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX;
enum VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX;
enum VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX;
enum VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHX;
enum VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHX = VkStructureType.VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHX;
enum VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX;
enum VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX = VkStructureType.VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX;
enum VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX;
enum VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX;
enum VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX;
enum VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX;
enum VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX;
enum VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX;
enum VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX = VkStructureType.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX;
...
// VK_KHR_extension_84
enum VK_KHR_EXTENSION_84_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_84_EXTENSION_NAME = "VK_KHR_extension_84";
...
enum VK_KHR_EXTENSION_113_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_113_EXTENSION_NAME = "VK_KHR_extension_113";

// VK_KHR_extension_114
enum VK_KHR_EXTENSION_114_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_114_EXTENSION_NAME = "VK_KHR_extension_114";

// VK_KHR_extension_115
enum VK_KHR_EXTENSION_115_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_115_EXTENSION_NAME = "VK_KHR_extension_115";

// VK_KHR_extension_116
enum VK_KHR_EXTENSION_116_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_116_EXTENSION_NAME = "VK_KHR_extension_116";
...
enum VK_KHR_variable_pointers_SPEC_VERSION = 0;
...
enum VK_KHR_EXTENSION_131_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_131_EXTENSION_NAME = "VK_KHR_extension_131";

// VK_KHR_extension_132
enum VK_KHR_EXTENSION_132_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_132_EXTENSION_NAME = "VK_KHR_extension_132";

// VK_KHR_relaxed_block_layout
enum VK_KHR_relaxed_block_layout_SPEC_VERSION = 0;
...
enum VK_KHR_extension_147_SPEC_VERSION = 0;
enum VK_KHR_extension_147_EXTENSION_NAME = "VK_KHR_extension_147";
...
enum VK_EXT_DEBUG_REPORT_SPEC_VERSION = 6;
...
// VK_AMD_extension_42
enum VK_AMD_EXTENSION_42_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_42_EXTENSION_NAME = "VK_AMD_extension_42";

// VK_AMD_extension_43
enum VK_AMD_EXTENSION_43_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_43_EXTENSION_NAME = "VK_AMD_extension_43";
...
// VK_AMD_extension_47
enum VK_AMD_EXTENSION_47_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_47_EXTENSION_NAME = "VK_AMD_extension_47";
...
enum VK_KHX_DEVICE_GROUP_SPEC_VERSION = 1;
...
struct VkBindBufferMemoryInfoKHX {
	VkStructureType     sType = VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_INFO_KHX;
	const( void )*      pNext;
	VkBuffer            buffer;
	VkDeviceMemory      memory;
	VkDeviceSize        memoryOffset;
...
struct VkBindImageMemoryInfoKHX {
	VkStructureType     sType = VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_INFO_KHX;
	const( void )*      pNext;
	VkImage             image;
	VkDeviceMemory      memory;
	VkDeviceSize        memoryOffset;
...
enum VK_LUID_SIZE_KHX = 8;
enum VK_KHX_EXTERNAL_MEMORY_CAPABILITIES_SPEC_VERSION = 1;
enum VK_KHX_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME = "VK_KHX_external_memory_capabilities";
...
// VkExternalMemoryHandleTypeFlagBitsKHX global enums
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX;
enum VK_EXTERNAL_MEMORY_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX = VkExternalMemoryHandleTypeFlagBitsKHX.VK_EXTERNAL_MEMORY_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX;
alias VkExternalMemoryHandleTypeFlagsKHX = VkFlags;
...
// VkExternalMemoryFeatureFlagBitsKHX global enums
enum VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX = VkExternalMemoryFeatureFlagBitsKHX.VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX;
enum VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX = VkExternalMemoryFeatureFlagBitsKHX.VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX;
enum VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX = VkExternalMemoryFeatureFlagBitsKHX.VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX;
enum VK_EXTERNAL_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM_KHX = VkExternalMemoryFeatureFlagBitsKHX.VK_EXTERNAL_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM_KHX;
alias VkExternalMemoryFeatureFlagsKHX = VkFlags;
...
struct VkPhysicalDeviceExternalImageFormatInfoKHX {
	VkStructureType                        sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX;
	const( void )*                         pNext;
	VkExternalMemoryHandleTypeFlagBitsKHX  handleType;
}

struct VkExternalImageFormatPropertiesKHX {
	VkStructureType                sType = VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX;
	void*                          pNext;
	VkExternalMemoryPropertiesKHX  externalMemoryProperties;
}

struct VkPhysicalDeviceExternalBufferInfoKHX {
	VkStructureType                        sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX;
	const( void )*                         pNext;
	VkBufferCreateFlags                    flags;
	VkBufferUsageFlags                     usage;
	VkExternalMemoryHandleTypeFlagBitsKHX  handleType;
...
struct VkExternalBufferPropertiesKHX {
	VkStructureType                sType = VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX;
	void*                          pNext;
	VkExternalMemoryPropertiesKHX  externalMemoryProperties;
}

struct VkPhysicalDeviceIDPropertiesKHX {
	VkStructureType              sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX;
	void*                        pNext;
	uint8_t[ VK_UUID_SIZE ]      deviceUUID;
	uint8_t[ VK_UUID_SIZE ]      driverUUID;
	uint8_t[ VK_LUID_SIZE_KHX ]  deviceLUID;
...
enum VK_QUEUE_FAMILY_EXTERNAL_KHX = (~0U-1);

struct VkExternalMemoryImageCreateInfoKHX {
	VkStructureType                     sType = VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX;
	const( void )*                      pNext;
	VkExternalMemoryHandleTypeFlagsKHX  handleTypes;
}

struct VkExternalMemoryBufferCreateInfoKHX {
	VkStructureType                     sType = VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX;
	const( void )*                      pNext;
	VkExternalMemoryHandleTypeFlagsKHX  handleTypes;
}

struct VkExportMemoryAllocateInfoKHX {
	VkStructureType                     sType = VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX;
	const( void )*                      pNext;
	VkExternalMemoryHandleTypeFlagsKHX  handleTypes;
}
...
version( VK_USE_PLATFORM_WIN32_KHR ) {
	...
	enum VK_KHX_EXTERNAL_MEMORY_WIN32_SPEC_VERSION = 1;
	enum VK_KHX_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME = "VK_KHX_external_memory_win32";
	
	struct VkImportMemoryWin32HandleInfoKHX {
		VkStructureType                        sType = VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHX;
		const( void )*                         pNext;
		VkExternalMemoryHandleTypeFlagBitsKHX  handleType;
		HANDLE                                 handle;
	}
	...
	struct VkExportMemoryWin32HandleInfoKHX {
		VkStructureType                sType = VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHX;
		const( void )*                 pNext;
		const( SECURITY_ATTRIBUTES )*  pAttributes;
		DWORD                          dwAccess;
		LPCWSTR                        name;
	...
	struct VkMemoryWin32HandlePropertiesKHX {
		VkStructureType  sType = VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHX;
		void*            pNext;
		uint32_t         memoryTypeBits;
	}
}
...
enum VK_KHX_EXTERNAL_MEMORY_FD_SPEC_VERSION = 1;
enum VK_KHX_EXTERNAL_MEMORY_FD_EXTENSION_NAME = "VK_KHX_external_memory_fd";

struct VkImportMemoryFdInfoKHX {
	VkStructureType                        sType = VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX;
	const( void )*                         pNext;
	VkExternalMemoryHandleTypeFlagBitsKHX  handleType;
	int                                    fd;
}
...
struct VkMemoryFdPropertiesKHX {
	VkStructureType  sType = VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX;
	void*            pNext;
	uint32_t         memoryTypeBits;
}
...
version( VK_USE_PLATFORM_WIN32_KHR ) {
	...
	enum VK_KHX_WIN32_KEYED_MUTEX_SPEC_VERSION = 1;
	enum VK_KHX_WIN32_KEYED_MUTEX_EXTENSION_NAME = "VK_KHX_win32_keyed_mutex";
	
	struct VkWin32KeyedMutexAcquireReleaseInfoKHX {
		VkStructureType           sType = VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX;
		const( void )*            pNext;
		uint32_t                  acquireCount;
		const( VkDeviceMemory )*  pAcquireSyncs;
		const( uint64_t )*        pAcquireKeys;
...
enum VK_KHX_EXTERNAL_SEMAPHORE_CAPABILITIES_SPEC_VERSION = 1;
enum VK_KHX_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME = "VK_KHX_external_semaphore_capabilities";
...
// VkExternalSemaphoreHandleTypeFlagBitsKHX global enums
enum VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX = VkExternalSemaphoreHandleTypeFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX;
...
enum VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX = VkExternalSemaphoreHandleTypeFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX;
enum VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX = VkExternalSemaphoreHandleTypeFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX;
enum VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX = VkExternalSemaphoreHandleTypeFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX;
enum VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX = VkExternalSemaphoreHandleTypeFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX;
alias VkExternalSemaphoreHandleTypeFlagsKHX = VkFlags;
...
// VkExternalSemaphoreFeatureFlagBitsKHX global enums
enum VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX = VkExternalSemaphoreFeatureFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX;
enum VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX = VkExternalSemaphoreFeatureFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX;
enum VK_EXTERNAL_SEMAPHORE_FEATURE_FLAG_BITS_MAX_ENUM_KHX = VkExternalSemaphoreFeatureFlagBitsKHX.VK_EXTERNAL_SEMAPHORE_FEATURE_FLAG_BITS_MAX_ENUM_KHX;
alias VkExternalSemaphoreFeatureFlagsKHX = VkFlags;

struct VkPhysicalDeviceExternalSemaphoreInfoKHX {
	VkStructureType                           sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX;
	const( void )*                            pNext;
	VkExternalSemaphoreHandleTypeFlagBitsKHX  handleType;
}

struct VkExternalSemaphorePropertiesKHX {
	VkStructureType                        sType = VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX;
	void*                                  pNext;
...
enum VK_KHX_EXTERNAL_SEMAPHORE_SPEC_VERSION = 1;
enum VK_KHX_EXTERNAL_SEMAPHORE_EXTENSION_NAME = "VK_KHX_external_semaphore";

struct VkExportSemaphoreCreateInfoKHX {
	VkStructureType                        sType = VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX;
	const( void )*                         pNext;
...
version( VK_USE_PLATFORM_WIN32_KHR ) {
	...
	enum VK_KHX_EXTERNAL_SEMAPHORE_WIN32_SPEC_VERSION = 1;
	enum VK_KHX_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME = "VK_KHX_external_semaphore_win32";
	
	struct VkImportSemaphoreWin32HandleInfoKHX {
		VkStructureType                        sType = VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX;
		const( void )*                         pNext;
		VkSemaphore                            semaphore;
	...
	struct VkExportSemaphoreWin32HandleInfoKHX {
		VkStructureType                sType = VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX;
		const( void )*                 pNext;
		const( SECURITY_ATTRIBUTES )*  pAttributes;
		DWORD                          dwAccess;
		LPCWSTR                        name;
	...
	struct VkD3D12FenceSubmitInfoKHX {
		VkStructureType     sType = VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX;
		const( void )*      pNext;
...
enum VK_KHX_EXTERNAL_SEMAPHORE_FD_SPEC_VERSION = 1;
enum VK_KHX_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME = "VK_KHX_external_semaphore_fd";

struct VkImportSemaphoreFdInfoKHX {
	VkStructureType                           sType = VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX;
	const( void )*                            pNext;
	VkSemaphore                               semaphore;
	VkExternalSemaphoreHandleTypeFlagBitsKHX  handleType;
	int                                       fd;
...
enum VK_NVX_DEVICE_GENERATED_COMMANDS_SPEC_VERSION = 1;
...
enum VK_INDIRECT_COMMANDS_TOKEN_PIPELINE_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_PIPELINE_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_DESCRIPTOR_SET_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_DESCRIPTOR_SET_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_INDEX_BUFFER_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_INDEX_BUFFER_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_VERTEX_BUFFER_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_VERTEX_BUFFER_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_PUSH_CONSTANT_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_PUSH_CONSTANT_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_DRAW_INDEXED_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_DRAW_INDEXED_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_DRAW_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_DRAW_NVX;
enum VK_INDIRECT_COMMANDS_TOKEN_DISPATCH_NVX = VkIndirectCommandsTokenTypeNVX.VK_INDIRECT_COMMANDS_TOKEN_DISPATCH_NVX;
...
enum VK_OBJECT_ENTRY_DESCRIPTOR_SET_NVX = VkObjectEntryTypeNVX.VK_OBJECT_ENTRY_DESCRIPTOR_SET_NVX;
enum VK_OBJECT_ENTRY_PIPELINE_NVX = VkObjectEntryTypeNVX.VK_OBJECT_ENTRY_PIPELINE_NVX;
enum VK_OBJECT_ENTRY_INDEX_BUFFER_NVX = VkObjectEntryTypeNVX.VK_OBJECT_ENTRY_INDEX_BUFFER_NVX;
enum VK_OBJECT_ENTRY_VERTEX_BUFFER_NVX = VkObjectEntryTypeNVX.VK_OBJECT_ENTRY_VERTEX_BUFFER_NVX;
enum VK_OBJECT_ENTRY_PUSH_CONSTANT_NVX = VkObjectEntryTypeNVX.VK_OBJECT_ENTRY_PUSH_CONSTANT_NVX;
...
struct VkSurfaceCapabilities2EXT {
	VkStructureType                sType = VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES2_EXT;
	void*                          pNext;
	uint32_t                       minImageCount;
	uint32_t                       maxImageCount;
	VkExtent2D                     currentExtent;
...
// VK_NV_extension_102
enum VK_NV_EXTENSION_102_SPEC_VERSION = 0;
enum VK_NV_EXTENSION_102_EXTENSION_NAME = "VK_NV_extension_102";
...
enum VK_EXT_SWAPCHAIN_COLOR_SPACE_SPEC_VERSION = 2;
...
enum VK_MESA_EXTENSION_126_SPEC_VERSION = 0;
enum VK_MESA_EXTENSION_126_EXTENSION_NAME = "VK_MESA_extension_126";
...
enum VK_AMD_EXTENSION_133_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_133_EXTENSION_NAME = "VK_AMD_extension_133";
...
enum VK_AMD_EXTENSION_137_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_137_EXTENSION_NAME = "VK_AMD_extension_137";

// VK_AMD_extension_138
enum VK_AMD_EXTENSION_138_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_138_EXTENSION_NAME = "VK_AMD_extension_138";
...
enum VK_AMD_EXTENSION_141_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_141_EXTENSION_NAME = "VK_AMD_extension_141";
...
enum VK_AMD_EXTENSION_144_SPEC_VERSION = 0;
enum VK_AMD_EXTENSION_144_EXTENSION_NAME = "VK_AMD_extension_144";

// VK_EXT_extension_148
enum VK_KHR_EXTENSION_148_SPEC_VERSION = 0;
enum VK_KHR_EXTENSION_148_EXTENSION_NAME = "VK_EXT_extension_148";

// VK_NV_extension_149
enum VK_NV_EXTENSION_149_SPEC_VERSION = 0;
enum VK_NV_EXTENSION_149_EXTENSION_NAME = "VK_NV_extension_149";

// VK_NV_extension_150
enum VK_NV_EXTENSION_150_SPEC_VERSION = 0;
enum VK_NV_EXTENSION_150_EXTENSION_NAME = "VK_NV_extension_150";
...
// VK_NV_extension_153
enum VK_NV_EXTENSION_153_SPEC_VERSION = 0;
enum VK_NV_EXTENSION_153_EXTENSION_NAME = "VK_NV_extension_153";

// VK_NV_extension_154
enum VK_NV_EXTENSION_154_SPEC_VERSION = 0;
enum VK_NV_EXTENSION_154_EXTENSION_NAME = "VK_NV_extension_154";
...
// VK_NV_extension_156
enum VK_NV_EXTENSION_156_SPEC_VERSION = 0;
enum VK_NV_EXTENSION_156_EXTENSION_NAME = "VK_NV_extension_156";
