...
template Aes(Specs...)
{
    ...
    alias defaultNames = TypeTuple!("colour", "size", "angle", "alpha");
    alias defaultTypes = TypeTuple!(string, double, double, double);
    alias defaultValues = TypeTuple!(q{"black"}, 10, 0, 1);
    string injectFront()
    {
        import std.format : format;
