...
unittest
{
    template Tuple2(Specs...)
    {
        ...
        struct Tuple2
        {
            ...
            {
                @property
                    ref inout(Tuple2!Types) _Tuple_super() inout @trusted
                    {
            ...
            size_t length()
            {
                ...
                size_t l = field[0].walkLength; 
                foreach (i, Unused; Types[1..$])
                {
    ...
    import std.stdio;
    auto tup = Tuple2!(double[], "x", 
            double[], "y", string[], "colour")(
                [0,1],[2,1],
                ["white","white2"]);
    auto tup2 = Tuple2!(double[], "x", 
            double[], "y")([0,1],[2,1]);
