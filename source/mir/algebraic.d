...
$(LI 5. Pattern matching with common D overload resolution with $(LREF match), $(LREF tryMatch), and $(LREF optionalMatch). The last function always returns $(LREF Nullable).)
$(LI 6. Variant's member access with $(LREF getMember), $(LREF tryGetMember), and $(LREF optionalGetMember). The last function always returns $(LREF Nullable).)
