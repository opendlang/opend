...
FuncDeclaration buildOpAssign(StructDeclaration sd, Scope* sc)
{
    ...
    fparams.push(new Parameter(loc, STC.nodtor, sd.type, Id.p, null, null, null));
...
FuncDeclaration buildXopEquals(StructDeclaration sd, Scope* sc)
{
    ...
    if (Dsymbol eq = search_function(sd, Id.eq))
    {
        if (FuncDeclaration fd = eq.isFuncDeclaration())
        {
            TypeFunction tfeqptr;
            {
                ...
                parameters.push(new Parameter(Loc.initial, STC.ref_ | STC.const_, sd.type, null, null, null, null));
    ...
    auto parameters = new Parameters();
    parameters.push(new Parameter(loc, STC.ref_ | STC.const_, sd.type, Id.p, null, null, null));
...
private DtorDeclaration buildWindowsCppDtor(AggregateDeclaration ad, DtorDeclaration dtor, Scope* sc)
{
    ...
    //   return (void*) this;
    // }
    Parameter delparam = new Parameter(Loc.initial, STC.undefined_, Type.tuns32, Identifier.idPool("del"), new IntegerExp(dtor.loc, 0, Type.tuns32), null, null);
...
private CtorDeclaration generateCopyCtorDeclaration(StructDeclaration sd, const StorageClass paramStc, const StorageClass funcStc)
{
    ...
    fparams.push(new Parameter(Loc.initial, paramStc | STC.ref_ | STC.return_ | STC.scope_, structType, Id.p, null, null, null));
