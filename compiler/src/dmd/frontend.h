...
struct Param final
{
    ...
    Param() :
        ...
        useUnitTests(),
        unittestFilter((UnittestFilter)0u),
        useInline(false),
        release(),
        preservePaths(),
