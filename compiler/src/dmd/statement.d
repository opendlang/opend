...
extern (C++) final class WithStatement : Statement
{
    ...
    extern (D) this(const ref Loc loc, Parameter prm, Expression exp, Statement _body, Loc endloc) @safe
    {
        super(loc, STMT.With);
        this.prm = prm;
        this.exp = exp;
    ...
    {
        return new WithStatement(loc, prm ? prm.syntaxCopy() : null, exp.syntaxCopy(), _body ? _body.syntaxCopy() : null, endloc);
    }
