...
---
    ...
    static immutable previews = [
        Feature("dip25", "useDIP25",
            "implement https://github.com/dlang/DIPs/blob/master/DIPs/archive/DIP25.md (Sealed references) - enabled by default", true, true),
        Feature("dip1000", "useDIP1000",
            "implement https://github.com/dlang/DIPs/blob/master/DIPs/other/DIP1000.md (Scoped Pointers)"),
        Feature("dip1008", "ehnogc",
            "implement https://github.com/dlang/DIPs/blob/master/DIPs/other/DIP1008.md (@nogc Throwable) - unsupported"),
        ...
        Feature("fieldwise", "fieldwise", "use fieldwise comparisons for struct equality - enabled by default", false, false),
        Feature("fixAliasThis", "fixAliasThis",
            "when a symbol is resolved, check alias this scope before going to upper scopes - enabled by default", false, false),
        Feature("intpromote", "fix16997",
            "fix integral promotions for unary + - ~ operators - enabled by default", false, true),
        Feature("dtorfields", "dtorFields",
            "destruct fields of partially constructed objects - enabled by default", false, false),
        Feature("rvaluerefparam", "rvalueRefParam",
            "enable rvalue arguments to ref parameters - enabled by default", false, false),
        ...
        Feature("fixImmutableConv", "fixImmutableConv",
            "disallow unsound immutable conversions that were formerly incorrectly permitted - enabled by default", false, false),
        Feature("systemVariables", "systemVariables",
            "disable access to variables marked '@system' from @safe code - enabled by default", false, false),
        Feature("privateThis", "privateThis",
            "add `private(this)` visibility attribute, private to the class/struct/union instead of module - enabled by default", false, false),
    ];
}
